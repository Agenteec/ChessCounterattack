...
//                            std::cout << "+++\n";
//                            // ƒобавл€ем обработку событий мыши
//                            if (event.type == sf::Event::MouseButtonPressed && event.mouseButton.button == sf::Mouse::Left)
//                            {
//                                // ќпредел€ем координаты мыши при нажатии на фигуру
...
//                                    b = 0;
//                                }
//                                // Ќаходим фигуру, на которую нажал пользователь
//                                for (int i = 0; i < CB.XMax; i++)
//                                {
//                                    for (int j = 0; j < CB.YMax; j++)
//                                    {
//                                        if (CB.board[i][j] != 12)
//                                        {
//                                            // ѕолучаем позицию фигуры на доске
//                                            sf::Vector2f piecePosition = ChessPicesSprite[CB.board[i][j]].getPosition();

//                                            // ѕровер€ем, находитс€ ли мышь внутри фигуры
...
//                                            {
//                                                // —охран€ем позицию фигуры и выходим из цикла
...
//                            {
//                                // ќпредел€ем координаты мыши при отпускании фигуры
//                                mousePosition = sf::Vector2f(event.mouseButton.x, event.mouseButton.y);
//                            }
//                        }
//                    }
